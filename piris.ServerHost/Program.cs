...
namespace piris.ServerHost
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //AuthService 
            var authServiceHost = new ServiceHost(typeof(_piris.DomainService.AuthService), new
            ...
            //CentralBankService 
            var centralBankServiceHost = new ServiceHost(typeof(_piris.DomainService.CentralBankService), new
            ...
            //PositionService 
            var positionServiceHost = new ServiceHost(typeof(_piris.DomainService.PositionService), new
            ...
            //DatabaseService 
            var databaseServiceHost = new ServiceHost(typeof(_piris.DomainService.DbContext.DatabaseService), new
            Uri($"net.tcp://{serviceAddress}/databaseService"));

            databaseServiceHost.AddServiceEndpoint(typeof(_piris.DomainService.DbContext.IDatabaseService), serverBinding, "");
